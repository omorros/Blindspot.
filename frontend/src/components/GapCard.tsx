  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full px-5 py-4 flex items-start gap-4 text-left group cursor-pointer"
      >
        {/* Rank number */}
        <span className="flex-none w-7 h-7 rounded-lg bg-[var(--surface-overlay)] border border-[var(--border-subtle)]
                        flex items-center justify-center text-xs font-medium text-[var(--text-muted)] mt-0.5">
          {rank}
        </span>
        ...
        <div className="flex-none flex items-center gap-3 mt-0.5">
          ...
          <span className={`text-sm font-medium tabular-nums px-2 py-0.5 rounded-md border ${scoreColor} ${scoreBg}`}>
                  ...
                  {gap.triangulation.map((signal) => {
                    ...
                    return (
                      <div key={signal.source} className="flex items-center gap-3">
                        ...
                        <div className="flex-1 h-1 bg-[var(--surface-overlay)] rounded-full max-w-[300px] relative overflow-hidden">
                          <div
                ...
                <div className="space-y-1.5">
                  {gap.risk_flags.map((risk, i) => (
                    <div key={i} className="flex items-start gap-2">
                      <span className="text-amber-500/70 text-xs mt-0.5 flex-none">!</span>
